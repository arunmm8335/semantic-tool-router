...
Generated: `2026-06-27T18:01:27Z`
...
- **FAIL** [filesystem] `Tell me the size and modification time of pyproject.toml`  
  Expected: `get_file_info`; retrieved: `edit_file, list_directory_with_sizes, get_file_info`; selected: `edit_file`
...
- **FAIL** [filesystem] `Read README and LICENSE together in one request`  
  Expected: `read_multiple_files`; retrieved: `read_media_file, read_multiple_files, read_text_file`; selected: `read_media_file`
...
- **FAIL** [memory] `Remember Arun as a person who is researching tool discovery`  
  Expected: `create_entities`; retrieved: `search_nodes, add_observations, create_entities`; selected: `search_nodes`
...
- **FAIL** [memory] `Record that the benchmark suite depends on the router library`  
  Expected: `create_relations`; retrieved: `open_nodes, read_graph, add_observations`; selected: `open_nodes`
